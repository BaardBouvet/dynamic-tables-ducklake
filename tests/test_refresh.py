...
class TestDynamicTableRefresh:
    ...
    @pytest.fixture
    def refresher(self, metadata_store, duckdb_conn):
        """Create a refresher instance."""
        return DynamicTableRefresher(metadata_store, duckdb_conn)
    
    @pytest.fixture
    def sample_source_data(self, duckdb_conn):
    ...
    def test_create_dynamic_table(self, refresher, sample_source_data):
    ...
    def test_create_duplicate_table(self, refresher, sample_source_data):
    ...
    def test_create_circular_dependency(self, refresher, sample_source_data):
    ...
    def test_refresh_table(self, refresher, duckdb_conn, sample_source_data):
    ...
    def test_refresh_updates_existing_data(self, refresher, duckdb_conn, sample_source_data):
    ...
    def test_refresh_nonexistent_table(self, refresher):
        """Test refreshing a table that doesn't exist."""
        with pytest.raises(ValueError, match="does not exist"):
            refresher.refresh_table('nonexistent')
    
    def test_refresh_all_in_dependency_order(self, refresher, duckdb_conn, sample_source_data):
    ...
    def test_drop_table(self, refresher, duckdb_conn, sample_source_data):
    ...
    def test_cannot_drop_table_with_dependents(self, refresher, sample_source_data):
    ...
    def test_refresh_history_recorded(self, refresher, sample_source_data):
