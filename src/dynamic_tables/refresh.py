...
class DynamicTableRefresher:
    ...
    def __init__(self, metadata_store: MetadataStore, duckdb_conn):
    ...
    def drop_dynamic_table(self, table_name: str) -> None:
        ...
        if dependents:
            ...
            raise ValueError(
                f"Cannot drop '{table_name}': tables {dependent_names} depend on it"
            )
    ...
    def refresh_table(self, table_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            table_exists = self.duckdb.execute(f"""
